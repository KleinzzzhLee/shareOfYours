...
import com.hmdp.utils.TestClient;
...
public class ShopServiceImpl extends ServiceImpl<ShopMapper, Shop> implements IShopService {
    ...
    @Resource
    private TestClient redisClient;
    ...
    public Result queryShop(Long id) {
        Shop shop = redisClient.getOneByLogicalExpire(id, RedisConstants.SHOP_KEY + id, RedisConstants.LOCK_SHOP_KEY + id, Shop.class,
                RedisConstants.SHOP_TTL, TimeUnit.MINUTES,
                this::getById);
        if(shop == null) {
